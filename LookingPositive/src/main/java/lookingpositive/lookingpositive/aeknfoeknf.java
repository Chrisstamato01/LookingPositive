...
public class aeknfoeknf {
  ...
  public static void main(String[] args) {
     ...
     * 10); ArrayList<Profile> contactedpeople = new ArrayList<>(); Profile
     * katerina = new Profile("katerina", "papadopoulou", "6985078444",
     ...
     * = Eventsaver.day2; Eventsaver.fourteendays[2] = Eventsaver.day3;
     * Eventsaver.fourteendays[3] = Eventsaver.day4; Eventsaver.fourteendays[4]
     * = Eventsaver.day5; Eventsaver.fourteendays[5] = Eventsaver.day6;
     * Eventsaver.fourteendays[6] = Eventsaver.day7; Eventsaver.fourteendays[7]
     * = Eventsaver.day8; Eventsaver.fourteendays[8] = Eventsaver.day9;
     ...
     * Event event2 = new Event(oldDate, "koula", contactedpeople); Event event3
     * = new Event(newDate, "marina", contactedpeople); Event event4 = new
     ...
     * = 0; j < Eventsaver.today.eventlist.get(i).size(); j++) {
     *
     ...
     */
    /*
     * for (int kol = 0; kol < 14; kol++) { System.out.println("day" + kol);
     * System.out.println("start"); for (int i = 0; i <
     * Eventsaver.fourteendays[kol].eventlist.size(); i++) {
