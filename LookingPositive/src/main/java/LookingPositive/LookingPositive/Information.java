...
public class Information {
  public static void infoMenu() {
    ...
    while (g != -1) {
      ...
      case 1:
        System.out.println(
            "Η ασθένεια κορωνοϊού 2019 (Corona virus disease 2019, COVID-19), επίσης γνωστή ως οξεία αναπνευστική νόσος 2019-nCoV, "
      ...
      case 5:
        System.out.println(
            "Οι μάσκες που επιτρέπονται είναι οι χειρουργικές, οι εγκεκρυμένες μη χειρουργικές και οι υψηλής προστασίας."
      ...
      case 6:
        System.out.println(
            "Το προστιμο για τη μη χρηση μασκας καθως και για την κυκλοφορια εκτος κανονων ανερχεται στα 300 ευρω");
        break;
      case 7:
        g = -1;
        break;
