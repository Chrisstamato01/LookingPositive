...
public class aeknfoeknf {
	...
	public static void main(String[] args) {
		...
		Profile katerina = new Profile("katerina" , "papadopoulou","6985078444","glyafada",0 , "f" ,"oxi",34,false,0,"papadopoulos@gmail.com");
		Profile elisavet = new Profile("elisavet" , "exarxopoulou","6985078422","voula",1,"f","oxi",44,false,1,"papadopoulos@gmail.com");
		Profile mpampinos = new Profile("mpampinos" , "mpazndekas","6985078434","alimos",2,"m","oxi",55,false,2,"papadopoulos@gmail.com");
