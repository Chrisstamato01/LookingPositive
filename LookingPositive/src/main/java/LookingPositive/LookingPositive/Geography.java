...
//			current = cases1 + cases2 + cases3;
    ...
    return "Ο Δήμος " + mun
        + ", με βάση τα κρούσματα των τελευταίων ημερών, έχει χρώμα επικινδυνότητας "
        + color;
  }

// ΜΕΘΟΔΟΣ ΔΗΜΙΟΥΡΓΙΑΣ ΑΝΤΙΚΕΙΜΕΝΩΝ ΚΑΙ ΓΕΜΙΣΜΑ ΠΙΝΑΚΩΝ
  public static void fillTables() {
    facilities[0] = new Geography("Σούπερ Μάρκετ", "ΑΒ Βασιλοπουλος", "3Β"); // TΟ
                                                                             // B
                                                                             // ΣΤΟ
                                                                             // "3Β"
                                                                             // ΕΙΝΑΙ
    ...
    facilities[14] = new Geography("Σούπερ Μάρκετ", "ΑΒ Βασιλοπουλος",
        "Άλιμος");
    ...
    facilities[26] = new Geography("Σούπερ Μάρκετ", "SuperFoodsMarket",
        "Γλυφάδα");
    ...
    facilities[30] = new Geography("Εστατόριο", "Mexican de Glyfada",
        "Γλυφάδα");
